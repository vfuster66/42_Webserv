...
std::map<std::string, std::string> CgiRequestHandler::cgiInterpreters;

void CgiRequestHandler::initCgiInterpreters()
{
    cgiInterpreters["php"] = "/usr/bin/php-cgi";
    cgiInterpreters["py"] = "/usr/bin/python";
}


std::string CgiRequestHandler::getCgiInterpreter(const std::string& filePath)
{
